    ...
    def _compute_tax_totals(self):
        for order in self:
            ...
            if order.prime:
                ...
                tax_totals['prime_amount_formatted'] = '{:.2f}'.format(order.prime_amount).replace('.',
                                                                                                   ',') + ' ' + str(
